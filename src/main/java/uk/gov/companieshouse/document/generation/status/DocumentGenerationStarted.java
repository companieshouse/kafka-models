...
public class DocumentGenerationStarted extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -2998831678116816611L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"DocumentGenerationStarted\",\"namespace\":\"uk.gov.companieshouse.document.generation.status\",\"fields\":[{\"name\":\"requester_id\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"id\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
   ...
   */
  public static uk.gov.companieshouse.document.generation.status.DocumentGenerationStarted.Builder newBuilder() {
    return new uk.gov.companieshouse.document.generation.status.DocumentGenerationStarted.Builder();
  }
   ...
   * @return A new DocumentGenerationStarted RecordBuilder
   */
  public static uk.gov.companieshouse.document.generation.status.DocumentGenerationStarted.Builder newBuilder(uk.gov.companieshouse.document.generation.status.DocumentGenerationStarted.Builder other) {
    return new uk.gov.companieshouse.document.generation.status.DocumentGenerationStarted.Builder(other);
  }
   ...
   * @return A new DocumentGenerationStarted RecordBuilder
   */
  public static uk.gov.companieshouse.document.generation.status.DocumentGenerationStarted.Builder newBuilder(uk.gov.companieshouse.document.generation.status.DocumentGenerationStarted other) {
    return new uk.gov.companieshouse.document.generation.status.DocumentGenerationStarted.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DocumentGenerationStarted>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(uk.gov.companieshouse.document.generation.status.DocumentGenerationStarted.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(uk.gov.companieshouse.document.generation.status.DocumentGenerationStarted other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.requester_id)) {
        this.requester_id = data().deepCopy(fields()[0].schema(), other.requester_id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public uk.gov.companieshouse.document.generation.status.DocumentGenerationStarted.Builder setRequesterId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public uk.gov.companieshouse.document.generation.status.DocumentGenerationStarted.Builder clearRequesterId() {
      requester_id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public uk.gov.companieshouse.document.generation.status.DocumentGenerationStarted.Builder setId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public uk.gov.companieshouse.document.generation.status.DocumentGenerationStarted.Builder clearId() {
      id = null;
